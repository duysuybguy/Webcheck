...
ALTER TABLE chapter_user_status ADD PRIMARY KEY(userId, chapterId);
...
UPDATE chapter SET LESSON_LINK = 'https://docs.google.com/forms/d/1cXnJKKe5s1mjL7MWe3Gkpsa5ZigblNZHiMaxu4xES1w/edit' WHERE id=1;
UPDATE chapter SET LESSON_LINK = 'https://docs.google.com/forms/d/197rBvyvjIiKc76UY3fxny9un5k-IIUzZBSWyBPl286A/edit' WHERE id=2;
UPDATE chapter SET LESSON_LINK = 'https://docs.google.com/forms/d/1bYx3dzH2vBAyiMavdITKNQSye7XNWnN3PXq0YnHwMb8/edit' WHERE id=3;
