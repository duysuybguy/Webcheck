...
Route::middleware(['checkLogin', 'singleLogin', 'checkStatusUser'])->group(function () {
    ...
    Route::middleware(['checkAdmin'])->group(function () {
        ...
        Route::get('/chapter-management', 'AdminController@chapterManagerment')->name("chapterManagerment");
        Route::get('/chapter-list', 'AdminController@getListChapter')->name("getListChapter");
        Route::post('/reload-chapter', 'AdminController@reloadChapter')->name("reloadChapter");
        Route::post('/delete-chapter-data', 'AdminController@deleteChapterData')->name("deleteChapterData");
